...
def make_request_worker(
    ...
    Args:
        ...
        components: Request components to send.
    ...
    # Generate request ID for baseline matching
    request_body_str = components.raw_body if components.raw_body else str(components.parsed_body or "")
